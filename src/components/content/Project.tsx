...
const Project = () => {
  ...
  const dataProjects: IProject[] = [
    ...
    },
    {
      ...
      details: {
        description:
          "A private project under ongoing updates, supporting the Three of Us For German Shepherds Foundation. Utilizes TypeScript and Firebase for real-time data handling. Includes a public-facing site for awareness and fund-raising.",
